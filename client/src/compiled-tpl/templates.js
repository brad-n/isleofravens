angular.module('templates-main', ['js/contact/contact.html', 'js/faq/faq.html', 'js/header/header.tpl.html', 'js/player/faction_winloss.html', 'js/player/player_details.html', 'js/player/player_nemesis.html', 'js/player/player_rival.html', 'js/player/player_rounds.html', 'js/player/player_tournaments.html', 'js/player/top_players.html', 'js/search/main.html', 'js/search/search_form.tpl.html', 'js/search/search.html', 'js/stats/faction_matchups.html', 'js/stats/faction_wins_linechart.html', 'js/stats/match_details.html', 'js/stats/played_factions_linechart.html', 'js/stats/stats.html', 'js/whatsnew/whatsnew.html']);
...
angular.module("js/header/header.tpl.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("js/header/header.tpl.html",
    ...
    "            <!-- <li active-link=\"active\" link=\"{{baseURL}}stats\"><a href=\"{{baseURL}}stats\">Stats</a></li>  -->\n" +
