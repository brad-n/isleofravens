app.directive('playedFactionsLinechart',
    ['Api', 'ColorManager', function (Api,ColorManager) {
        ...
        return {
            ...
            replace: true,
            transclude: false,
            templateUrl: 'js/stats/played_factions_linechart.html',
            scope: {
                player: '=',
                mode: '&'
            }, 
            link : function(scope, elem, attrs){
            	...
            	scope.loadFactionEntryCounts = function(player){
            		...
            		Api.loadFactionEntries().then(function(result){
            			var res = result.data;
            			...
            			for(var i = 0; i < res.length; i++){
            				...
            				scope.processed_data[res[i].faction].push(res[i].entries);
            	...
            	scope.buildChart = function(){
            		...
            		var config = {
            			...
            			var ctx = document.getElementById("fent-ytd");
