...
//$tournaments = array_slice($tournaments, 1489);

//loop over all tournaments to games
foreach($tournaments as $tournament){
	
	$GLOBALS['current']['tournament'] = $tournament;
